...
# get path
path <-
    paste(dir(path = c('C:/', 'E:/'), pattern = 'PopDynCloud$', recursive = T, include.dirs = T, full.names = T)[1],'GeoData/data-proc/atlas/landuse_atlas_2009_1m_03035_tif', sep = '/')
...
```{r map}
p_map <-
 readRDS('E:/PopDynCloud/GeoData/data-proc/atlas/landuse_atlas_2009_1m_03035_tif/landuse_atlas_2009_1m_03035_tif.rds')
