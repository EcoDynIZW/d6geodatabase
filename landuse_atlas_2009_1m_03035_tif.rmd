...
# get path
path <-
    paste(dir(path = c('C:/', 'D:/', 'E:/'), pattern = 'PopDynIZW Dropbox$', recursive = T, include.dirs = T, full.names = T)[1],'GeoData/data-proc/atlas/landuse_atlas_2009_1m_03035_tif', sep = '/')
