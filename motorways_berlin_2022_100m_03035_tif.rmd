...
# get path
path <-
    paste(dir(path = c('C:/', 'E:/'), pattern = 'PopDynCloud$', recursive = T, include.dirs = T, full.names = T)[1],'GeoData/data-proc/berlin/motorways_berlin_2022_100m_03035_tif', sep = '/')
...
```{r map}
p_map <-
 readRDS('E:/PopDynCloud/GeoData/data-proc/berlin/motorways_berlin_2022_100m_03035_tif/motorways_berlin_2022_100m_03035_tif.rds')
