...
```{r data-impor}
path <-
    paste(dir(path = c('C:/', 'D:/', 'E:/'), pattern = 'PopDynIZW Dropbox$', recursive = T, include.dirs = T, full.names = T)[1],'GeoData/data-proc/berlin/motorways_berlin_2022_100m_03035_tif', sep = '/')
