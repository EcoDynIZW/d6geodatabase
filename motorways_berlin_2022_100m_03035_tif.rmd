...
# get path
path <-
    'C:/Users/wenzler/PopDynIZW Dropbox/GeoData/data-proc/berlin/motorways_berlin_2022_100m_03035_tif'
...
# 
# p_base_map + ggplot2::scale_fill_gradient(
#   low = "#f1effc",
#   high = "#221462",
...
p_map <- png::readPNG(here::here("img", paste0(unlist(stringi::stri_split(path, regex = "/"))[length(unlist(stringi::stri_split(path, regex = "/")))], ".png")), native = TRUE)
...
p_table + plot_annotation(title = meta$folder_name)
```
