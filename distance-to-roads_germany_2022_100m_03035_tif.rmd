...
# get path
path <-
    'E:/PopDynCloud/GeoData/data-proc/germany/distance-to-roads_germany_2022_100m_03035_tif'
...
# 
# base_plot <- d6geodata::plot_quantitative_map(tif = tif, p_base_map = p_base_map)
# #
