...
```{r data-impor}
path <- paste(stringi::stri_c((unlist(stringi::stri_split(here::here(), regex = '/'))[1:3]), collapse = '/'),'PopDynIZW Dropbox/GeoData/data-proc/germany/distance-to-roads_germany_2022_100m_03035_tif', sep = '/')
