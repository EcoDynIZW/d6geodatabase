...
```{r data-impor}
path <-
    paste(dir(path = c('C:/', 'D:/', 'E:/'), pattern = 'PopDynIZW Dropbox$', recursive = T, include.dirs = T, full.names = T)[1],'GeoData/data-proc/germany/distance-to-roads_germany_2022_100m_03035_tif', sep = '/')
